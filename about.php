...
<body>
	<span class="about_box center" style="height: 80%;">
		<span class="center text_box" style="padding-right:2vw;">
			...
			You may also read our <span style="color: #29afc4;"><a href="WiFinder/privacy_policy.php">privacy policy</a></span> and <span style="color: #29afc4;"><a href="/api_documentation.php">API documentation</a></span>
			<br/>
			<p>
			Site created by
			</p>
